...
return(
       ...
       <Container style={{width:"100%",padding:0}}>
        ...
        <div style={{flexDirection:'column', alignItems:'start',justifyContent:'center',display:'flex',width:'35%'}}>
         ...
         All details of projects will show up when you click on the button below.
            ...
            <Button variant="light" size="lg"style={{alignSelf:'flex-end',marginBlock:50,fontWeight:'bold',color:'#003D6B'}} onClick={()=>setClick(!isClick)} >See My Projects<FiArrowRight  style ={{marginLeft:10,fontWeight:5}}/></Button>   
       ...
       responsibility="Design and Develop whole application." github="https://github.com/supawadee0789/Match-the-Memory"/>
        ...
        <Carousel.Item>
          <ProjectComponent bgColor="#003D6B" img={img3} textColor="#E0EEF9" projTitle="React" projContent="This website was written by HTML,CSS,JavaScript and React.This website was created for learning to create website and using new library. Including a detailed description of my background and personal information."
